...
public class consultStudentPagePresenter extends Presenter<consultStudentPagePresenter.MyView, consultStudentPagePresenter.MyProxy> implements consultStudentPageUiHandlers
{
    ...
    public interface MyView extends View, HasUiHandlers<consultStudentPageUiHandlers> {
    ...
    @ProxyStandard
    @NameToken(NameTokens.CONSULT_STUDENT)
    //@UseGatekeeper(LoggedInGatekeeper.class)
    public interface MyProxy extends ProxyPlace<consultStudentPagePresenter> {
    }

    @Inject
    public consultStudentPagePresenter(EventBus eventBus, MyView view, MyProxy proxy) {
