...
public class studentEditProfilePageView extends ViewImpl implements studentEditProfilePagePagePresenter.MyView
{
    ...
    @Override
    public void setUiHandlers(studentEditProfilePageUiHandlers homePageUiHandlers) {

    }

    public interface Binder extends UiBinder<Widget, studentEditProfilePageView>
    {
    ...
    @Inject
    public studentEditProfilePageView(final Binder binder) {
